...
- Post-deploy health check: https://money-portfolio-red.vercel.app/ (HTTP 200 check)

### Custom deploy hooks
- Pre-merge: npm run build && npm run lint
- Deploy trigger: automatic on push to main (Vercel)
- Deploy status: poll production URL
- Health check: https://money-portfolio-red.vercel.app/
...
- [ ] Optionally add a `/api/health` route for better health checks
